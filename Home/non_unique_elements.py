"""
f you have 50 different plug types, appliances wouldn't be available and would be very expensive. But once an electric outlet 
becomes standardized, many companies can design appliances, and competition ensues, creating variety and better prices for 
consumers.
-- Bill Gates
...
def checkio(numbers: list) -> list:
    ...
    for i in range(len(numbers)):
        n = numbers.pop()
        if n in non_unique_numbers or n in numbers:
            non_unique_numbers.append(n)
    return non_unique_numbers
